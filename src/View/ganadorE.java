 ...
 * @author ulise
 */
public class ganadorE extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ganadorE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
